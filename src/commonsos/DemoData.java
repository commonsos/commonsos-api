...
public class DemoData {
  ...
  public void install() {
    ...
    transactionService.create(new Transaction().setRemitterId(admin.getId()).setAmount(new BigDecimal("2000")).setBeneficiaryId(elderly2.getId()).setCreatedAt(OffsetDateTime.now()));
  }
}
